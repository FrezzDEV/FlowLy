  ...
  Widget build(BuildContext context) => Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              label,
              style: const TextStyle(color: Color(0xFF858585), fontSize: 12, fontWeight: FontWeight.w600, letterSpacing: .4),
            ),
          ),
          Container(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(title, style: const TextStyle(color: Colors.white, fontSize: 15.5, fontWeight: FontWeight.w700)),
                    const SizedBox(height: 2),
                    Text(subtitle, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Color(0xFF858585), fontSize: 11.5, fontWeight: FontWeight.w500)),
                  ],
                ),
              ),
